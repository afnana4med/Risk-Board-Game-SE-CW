...
public partial class Player : Node    
{
    ...
    public int DecideNumberOfDiceToRoll(Territory territory, bool isAttacker)
    {
        int armyCount = territory.Armies;  // Confirm this is the correct property name.
        if (isAttacker) {
            return Math.Min(3, armyCount - 1);
        } else {
            return Math.Min(2, armyCount);
        }
    }
